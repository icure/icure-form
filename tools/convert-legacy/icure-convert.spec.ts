...
describe('Form conversion', () => {
	it('should convert an obstetrics form', () => {
		...
		const translated = convertLegacy(form, [incapacity, prescription, obstetrics_followup_short, obstetrics_followup_long, obstetrics_followup_midwife] as unknown as FormLayout[])
