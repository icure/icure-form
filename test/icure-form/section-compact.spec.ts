...
describe('Section.compact', () => {
	...
	test('is written back by toJson', () => {
		const section = new Section('Main', [], undefined, undefined, undefined, undefined, true)
	...
	test('survives a full Form round trip', () => {
		const form = new Form('Vaccins', [new Section('Main', [new CheckBox('Tedivax', { span: 6, options: { Tedivax: 'Tedivax' } })], undefined, undefined, undefined, undefined, true)])
