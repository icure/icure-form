...
// exercised end-to-end against sample 01.
...
test.describe('demo-app — renderer & hide-empty toggles', () => {
	...
	test('renderer toggle offers Form and Tabs — Form activates the plain form renderer', async ({ page }) => {
		const buttons = page.locator('.renderer-toggle button')
		await expect(buttons).toHaveCount(2)
		await expect(buttons.nth(0)).toHaveText('Form')
		await expect(buttons.nth(1)).toContainText('Tabs')
